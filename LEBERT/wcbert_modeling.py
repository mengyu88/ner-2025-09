...
from transformers.models.bert.modeling_bert import BertAttention, BertIntermediate, BertOutput, load_tf_weights_in_bert, BertModel
...
class WCBertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        output_idx = 1
        if output_hidden_states:
            encoder_hidden_states = encoder_outputs[output_idx]
            output_idx += 1
        if output_attentions:
            encoder_attentions = encoder_outputs[output_idx]
