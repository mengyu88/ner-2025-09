...
class IdentifierTrainer(BaseTrainer):
    ...
    def train(self, train_path: str, valid_path: str, types_path: str, input_reader_cls: BaseInputReader):
        ...
        dataset_paths = {train_label: train_path, valid_label: valid_path}
        if args.test_path:
            dataset_paths[test_label] = args.test_path
        ...
        test_dataset = input_reader.get_dataset(test_label) if args.test_path else None
