...
def get_span_tokens(tokens, span):
    # Import lazily: util is imported while entities.py is still defining its
    # classes, so an eager TokenSpan import would create a circular import.
    from diffusionner.entities import TokenSpan
    inside = False
    span_tokens = []
