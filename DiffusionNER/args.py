...
def train_argparser():
    ...
    arg_parser.add_argument('--epoch_metrics_path', type=str, default=None,
                            help="Optional path to write one comma-separated entity metrics row per epoch")
...
def eval_argparser():
    ...
    # The evaluator forwards this value to JsonInputReader, but the original
    # eval parser omitted the training-side option.
    arg_parser.add_argument('--repeat_gt_entities', type=int, default=-1)
